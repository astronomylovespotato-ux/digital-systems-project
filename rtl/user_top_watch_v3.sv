...
module user_top_watch_v3 #(
  ...
  assign seconds_inc = mode_enable[0] && button[1];
  assign minutes_inc = mode_enable[1] && button[1];
  assign hours_inc = mode_enable[2] && button[1];

  // button 2 decrement
  assign seconds_dec = mode_enable[0] && button[2];
  assign minutes_dec = mode_enable[1] && button[2];
  assign hours_dec = mode_enable[2] && button[2];
